...
- Canonical repo target: `kotlin-math-rational`. Useful entrypoints: `dev project show kotlin-math-rational`, `dev build kotlin-math-rational`, `dev check kotlin-math-rational`.
- Setup-managed files are regenerated with `dev setup kotlin-math-rational`; avoid hand-editing stamped generated files.
