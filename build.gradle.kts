...
// managed-integrity-v1: BkiEukqk5Sc
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-math-rational", project.version.toString())
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-math-rational"
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-math-rational/tree/master/src")
